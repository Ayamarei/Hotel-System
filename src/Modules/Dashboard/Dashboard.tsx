...
const Dashboard = () => {
  ...
  const data1 = {
    labels: [t("Dashboard.completed"),t("Dashboard.pending")],
    datasets: [
      {
        label: t("Dashboard.Booking"),
        data: [
            ...
            <Item sx={{ height: "180px", backgroundColor: "#1A2027" }}>
              ...
              >
                <div>
                  ...
                  <Typography>{t("Dashboard.Rooms")}</Typography>
                </div>
                <WorkOutline
                  sx={{
            ...
            <Item sx={{ height: "180px", backgroundColor: "#1A2027" }}>
              ...
              >
                <div>
                  ...
                  <Typography>{t("Dashboard.Facilities")}</Typography>
                </div>
                <WorkOutline
                 sx={{
                  color: THEMECOLOR.Dark_Baby_Blue,
            ...
            <Item sx={{ height: "180px", backgroundColor: "#1A2027" }}>
              ...
              >
                <div>
                  ...
                  <Typography>{t("Dashboard.Ads")}</Typography>
                </div>
                <WorkOutline
                  sx={{
                    color: THEMECOLOR.Dark_Baby_Blue,
