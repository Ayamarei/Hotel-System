...
export default function PopularAds() {
  ...
  console.log("allAdsallAds", allAds[0]?.room?.images[0]);
  ...
  return (
    <>
      <Box sx={{ padding: { xs: "20px", md: "50px", display: "flex" } }}>
        <Grid container spacing={3} sx={{ my: { xs: 8, sm: 8, md: 5 } }}>
          {allAds[0]?.room?.images && allAds[0]?.room?.images.length > 0 ? (
            <img
                  ...
                  >
                    ...
                    <Box>
                      ...
                      <VisibilityOutlinedIcon
                        ...
                        onClick={() =>
                          navigate(`/explore-details/${Ad.room._id}`)
                        }
                      />
                    </Box>
                  </Box>
