                ...
                <Grid  size={{xs:12 ,sm:4 }}  sx={{ position: "relative",textAlign:i18n.language === 'ar' ? 'start' :'end',m:5,marginBottom:0,paddingTop:5,height:"490px",width:'350px'}}>
                  <Box
                    sx={{
                        ...
                        borderRadius: i18n.language === 'ar' ? '30px 30px  30px 100px' : "30px 30px 100px 30px",
                        zIndex: 0,  
                    }}
                />
                  <img 
                    ...
                    width="90%"
                    height="90%"
                    style={{borderRadius: i18n.language === 'ar' ? '30px 30px  30px 100px' :'30px 30px 100px 30px', position: "relative",zIndex:1}}
                />
