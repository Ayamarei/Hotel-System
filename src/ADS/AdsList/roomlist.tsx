...
//   const [selectedRoom, setselectedRoom] = React.useState<IRoomData | null>(
//     null
//   );
...
//           ROOMS_URLS.DELETE_ROOMS(selectedRoom?._id)
//         );
//         getAllRooms(5, 1);
//         handleCloseDelete();
...
//     setLoading(true);
//     try {
//       const response = await privateUserAxiosInstance.get<IRoomsResponse>(
//         ROOMS_URLS.GET_ROOMS,
//         {
//           params: {
//             page,
//             size,
